      ...
      <div class="card-body">
        ...
        <form  action="{{route('update.social', $social->id)}}" method="POST">
          ...
          <div class="form-group">
            <label for="category_eng">Facebook</label>
          ...
          <div class="form-group">
            <label for="categoryFrench">Twitter</label>
          ...
          <div class="form-group">
            <label for="categoryFrench">Youtube</label>
          ...
          <div class="form-group">
            <label for="categoryFrench">Linkedin</label>
          ...
          <div class="form-group">
            <label for="categoryFrench">Instagram</label>
