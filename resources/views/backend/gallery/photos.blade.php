      ...
      <table class="table table-bordered">
        ...
        @foreach($galleries as $gallery)
          <tr>
            <td> {{$count++}} </td>
            <td> {{$gallery->title}} </td>
            <td> <img src="{{asset($gallery->photo) }}" style="width: 50px; height: 50px "> </td>
            ...
            <a href="{{route('delete.photo', $gallery->id)}}" onclick="return confirm('Are You Sure Enough?')" class="btn btn-danger">Delete</a>
         </td>
          </tr>
          @endforeach
        </tbody>
