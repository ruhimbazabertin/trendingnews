...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 ...
 <div class="content-wrapper">
   ...
   <div class="col-12 grid-margin stretch-card">
                    ...
                    <form action="{{ route('store.post') }}" method="post" enctype="multipart/form-data">
                     ...
                     <div class="form-group col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title_hind">
                      </div>
                    </div>
                  </div><!-- End -->
                      ...
                      <label for="Category">Category</label>
                       <select class="form-control" name="category_id">
                          ...
                          <option value="{{$category->id}}">{{$category->category_eng}}|{{$category->category_hind}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                     ...
                     <div class="form-group col-md-6">
                      ...
                      <label for="Category">District</label>
                       <select class="form-control" name="district_id">
                          ...
                          <option value="{{$district->id}}">{{$district->district_eng}}|{{$district->district_hind}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                ...
                <div class="mb-3">
                 <label for="formFile" class="form-label">News Image Upload</label>
                     ...
                     <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tags_eng">
                      </div>
                    </div>
                     ...
                     <div class="form-group col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tags_hind">
                      </div>
                    </div>
                  </div><!-- End -->
                     ...
                     <label for="detail_eng">Detail English</label>
                       <textarea class="form-control" name="details_eng" id="summernote1"></textarea>
                      </div>

                    <div class="form-group">
                     <label for="detail_hind">Detail French</label>
                       <textarea class="form-control" name="details_hind" id="summernote2"></textarea>
                      </div>
                      ...
                      <div class="row">
                          <label class="form-check-label col-md-3">
                           ...
                           <label class="form-check-label col-md-3">
                            <input type="checkbox" name="big_thumbnail" class="form-check-input" value="1">General Big Thumbnail <i class="input-helper"></i>
                          </label>
                           <label class="form-check-label col-md-3">
                            <input type="checkbox" name="first_section" class="form-check-input" value="1">First Section <i class="input-helper"></i>
                          </label>
                            <label class="form-check-label col-md-3">
                            <input type="checkbox" name="first_section_thumbnail" class="form-check-input">First Section BigThumbnail <i class="input-helper" value="1"></i>
                          </label>
                      </div><!--End Row-->
                        <br/>
                        <br/>
